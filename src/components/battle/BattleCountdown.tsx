        ...
        <div className="min-h-screen bg-[#0c0b10] text-white p-6 flex items-center justify-center">
            ...
            <div className="absolute inset-0 pointer-events-none overflow-hidden">
                ...
                <motion.div
                    ...
                    className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-pink-900/30 rounded-full blur-[120px]"
                />
            </div>
            ...
            <div className="max-w-6xl mx-auto relative z-10 w-full">
                ...
                >
                    <div className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-purple-900/50 to-pink-900/50 border-2 border-purple-500/50 rounded-full shadow-[0_0_50px_rgba(124,58,237,0.5)] mb-4">
                        <Clock className="w-8 h-8 text-purple-400" />
                        <motion.div
                            key={countdown}
                            initial={{ scale: 1.5, opacity: 0 }}
                            animate={{ scale: 1, opacity: 1 }}
                            className="text-6xl font-bold font-pixel text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400"
                        >
                            {countdown}
                        </motion.div>
                    </div>
                ...
                <motion.div
                    ...
                    className="mb-12"
                >
                    <div className="relative h-4 bg-[#13121a] border border-purple-500/30 rounded-full overflow-hidden">
                        <motion.div
                            initial={{ width: 0 }}
                            animate={{ width: `${progress}%` }}
                            className="absolute inset-y-0 left-0 bg-gradient-to-r from-purple-600 via-pink-600 to-purple-600 shadow-[0_0_20px_rgba(124,58,237,0.6)]"
                        />
                ...
                <motion.div
                    ...
                    className="bg-[#13121a] border border-purple-500/20 rounded-xl p-6 max-w-2xl mx-auto"
                >
                    <div className="flex items-center gap-2 mb-4">
                        <Zap className="w-5 h-5 text-purple-400" />
                        <h3 className="text-sm font-bold font-pixel text-purple-400 uppercase">Battle Log</h3>
                    </div>
                    <div className="space-y-2">
                        ...
                        >
                            <span className="text-gray-500 font-mono text-xs">{String(60 - countdown).padStart(2, '0')}s</span>
                            <span className="text-gray-300 font-mono text-sm">{currentMessage}</span>
                        </motion.div>
                    </div>
                </motion.div>
                ...
                >
                    <div className="bg-purple-900/20 border border-purple-500/30 rounded-lg p-4 text-center">
                        <div className="text-xs text-gray-400 font-mono mb-1">YOUR ROI</div>
                        <motion.div
                            animate={{
                                opacity: [0.5, 1, 0.5],
                            }}
                            ...
                            className="text-2xl font-bold font-pixel text-purple-400"
                        >
                            ???%
                        </motion.div>
                    </div>
                    <div className="bg-red-900/20 border border-red-500/30 rounded-lg p-4 text-center">
                        <div className="text-xs text-gray-400 font-mono mb-1">AI ROI</div>
                        <motion.div
                            animate={{
                                opacity: [0.5, 1, 0.5],
                            }}
                            ...
                            className="text-2xl font-bold font-pixel text-red-400"
                        >
                            ???%
                        </motion.div>
                    </div>
