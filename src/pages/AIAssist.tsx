            ...
            <div className="container mx-auto px-4 py-16 relative z-10 max-w-4xl">
                ...
                >
                    ...
                    <p className="text-base md:text-lg text-gray-400 font-mono max-w-2xl mx-auto leading-relaxed">
                        Describe what you want. AI will build the strategy for you.
                    </p>
                </motion.div>
                    ...
                    <div className="relative bg-[#13121a] border border-white/10 rounded-2xl overflow-hidden backdrop-blur-sm shadow-2xl">
                        <div className="relative p-6">
                            ...
                            <div className="flex items-center justify-between mt-4 pt-4 border-t border-white/5">
                                ...
                                <button className="px-8 py-3 rounded-full bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-bold text-sm hover:shadow-[0_0_25px_rgba(124,58,237,0.6)] transition-all flex items-center gap-2 group">
                        ...
                        <div className="p-6 space-y-6">
                            ...
                            <div className="bg-gradient-to-br from-purple-900/10 to-indigo-900/10 border border-purple-500/20 rounded-xl p-5">
                                <div className="flex items-start justify-between mb-3">
                                    <h3 className="text-xl font-bold text-white font-pixel">Momentum Alpha Strategy</h3>
                                ...
                                <div className="grid grid-cols-3 gap-4 pt-4 border-t border-white/5">
                                    <div>
                                        <div className="text-xs text-gray-500 uppercase tracking-wider mb-1 font-mono">Risk Level</div>
                                    ...
                                    <div>
                                        <div className="text-xs text-gray-500 uppercase tracking-wider mb-1 font-mono">Assets</div>
                                        <div className="text-sm font-mono text-white">BTC, ETH, SOL</div>
                                    </div>
                                    <div>
                                        <div className="text-xs text-gray-500 uppercase tracking-wider mb-1 font-mono">Timeframe</div>
                                        <div className="flex items-center gap-2">
                                            <TrendingUp className="w-4 h-4 text-blue-400" />
                                            <span className="text-sm font-mono text-white">4H - 1D</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
