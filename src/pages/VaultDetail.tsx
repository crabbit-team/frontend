    ...
    return (
        <div className="min-h-screen bg-[#0c0b10] text-white font-tech overflow-hidden relative pb-20">
            ...
            <div className="container mx-auto px-4 py-8 relative z-10">
                {/* Back Button */}
                <Link to="/rank" className="inline-flex items-center gap-2 text-muted-foreground hover:text-white transition-colors mb-8 group">
                    <ArrowLeft className="w-4 h-4 group-hover:-translate-x-1 transition-transform" />
                    <span className="font-mono text-sm">Back to Rank</span>
                </Link>

                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    {/* LEFT COLUMN (Vault Information) */}
                            ...
                            <div className="h-[300px] w-full flex items-center justify-center">
                                <ResponsiveContainer width="100%" height="100%">
                                    <PieChart>
                                        ...
                                        <Tooltip
                                            contentStyle={{ backgroundColor: '#1a1924', borderColor: '#333', borderRadius: '8px', color: '#fff' }}
                                            itemStyle={{ color: '#fff' }}
                                        />
                                        <Legend
                                            verticalAlign="bottom"
                                            height={36}
                                            formatter={(value) => <span className="text-white font-mono ml-2">{value}</span>}
                                        />
                                    </PieChart>
                                </ResponsiveContainer>
                            </div>
                    ...
                    <div className="lg:col-span-1">
                        ...
                        >
                            <div className="mb-6">
                                ...
                                <p className="text-xs text-muted-foreground font-mono">Add liquidity to this vault</p>
                            </div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="p-3 bg-purple-500/10 border border-purple-500/20 rounded-lg text-xs text-purple-200/80 text-center font-mono leading-relaxed">
                                    Your first 3 deposits are free.<br />
